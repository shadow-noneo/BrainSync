  ...
  return (
    ...
    <div className="app-container">
      ...
      <div style={{display:'flex', flexDirection:'column', alignItems:'center', width:'100%'}}>
        ...
        {gameState === 'menu' && (<div className="card" style={{textAlign:'center'}}><div style={{fontSize:'3.5em', marginBottom:'5px'}}>🧠</div><h1 style={{fontSize:'2em', fontWeight:800, letterSpacing:'-1px', marginBottom:'5px'}}>BrainSync</h1><p style={{color:'#888', fontSize:'0.85em', marginBottom:'25px', letterSpacing:'1px', textTransform:'uppercase'}}>AI Powered Live Quiz</p><h2 style={{textAlign:'left', fontSize:'1em', color:'#aaa', marginBottom:'5px', fontWeight:500}}>Student Login</h2><input className="input" placeholder="Enter Name" onChange={(e) => setUsername(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && roomInputRef.current.focus()} /><input className="input" ref={roomInputRef} placeholder="Room Code (101)" onChange={(e) => setRoomCode(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && joinRoom()} /><button className="primary-btn" onClick={joinRoom}>Enter Class</button></div>)}
