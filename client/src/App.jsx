  ...
  return (
    ...
    <div className="app-container">
      ...
      <div style={{display:'flex', flexDirection:'column', alignItems:'center', width:'100%'}}>
        ...
        {gameState === 'menu' && (<><div style={{textAlign:'center', marginBottom:'24px'}}><div style={{fontSize:'4em', marginBottom:'8px', filter:'drop-shadow(0 0 20px rgba(100,108,255,0.8))'}}>🧠</div><h1 style={{fontSize:'2.4em', fontWeight:900, letterSpacing:'-1.5px', background:'linear-gradient(135deg, #0A84FF, #5E5CE6, #FF375F)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', margin:0}}>BrainSync</h1></div><div className="card"><input className="input" placeholder="Enter Name" onChange={(e) => setUsername(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && roomInputRef.current.focus()} /><input className="input" ref={roomInputRef} placeholder="Room Code (101)" onChange={(e) => setRoomCode(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && joinRoom()} /><button className="primary-btn" onClick={joinRoom}>Enter Class</button></div></>
